...
questions = Question.create!(
  [
    { body: '{}?', test_id: tests[0] },
    { body: '[]?', test_id: tests[1] },
    { body: '<div>', test_id: tests[2] },
    { body: '<script>', test_id: tests[3] },
    { body: 'GET', test_id: tests[4] },
    { body: 'POST', test_id: tests[5] },
    { body: 'has_many', test_id: tests[3] },
    { body: 'has_one', test_id: tests[3] }
  ]
)
